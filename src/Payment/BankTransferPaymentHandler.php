...
class BankTransferPaymentHandler implements AsynchronousPaymentHandlerInterface
{
    ...
    public function __construct(OrderTransactionStateHandler $orderTransactionStateHandler, PaymentBuilderInterface $bankTransferBuilder, LoggerInterface $logger)
    {
